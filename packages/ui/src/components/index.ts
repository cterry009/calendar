...
export { Activity, BarChart3, Flame, Heart, HelpCircle, Leaf, Lightbulb, ListChecks, Plus, Settings, ShieldBan, Sunrise, Timer } from '@tamagui/lucide-icons';
  ...
  variants: {
    variant: {
      ...
      ghost: {
        ...
        hoverStyle: { borderColor: '$accent', backgroundColor: '$overlaySubtle', y: -1 },
        pressStyle: { backgroundColor: '$overlayMedium', scale: 0.98, y: 0 },
      },
      small: {
      ...
      mood: {
        backgroundColor: '$overlaySubtle',
        color: '$color',
        fontWeight: '500',
        flex: 1,
        minWidth: 120,
        hoverStyle: { backgroundColor: '$overlayMedium', y: -1 },
        pressStyle: { backgroundColor: '$overlayStrong', scale: 0.98, y: 0 },
      },
